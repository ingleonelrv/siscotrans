          ...
          <MuiPickersUtilsProvider utils={MomentUtils}>
            ...
            <FormControl className={classes.inputs}>
              ...
              <Select
                ...
                onChange={handleChange}
              >
                <MenuItem value={10}>Mano de Obra</MenuItem>
                <MenuItem value={20}>Repuesto Nuevo</MenuItem>
                <MenuItem value={30}>Repuesto Usado</MenuItem>
                <MenuItem value={30}>Mantenimiento</MenuItem>
                <MenuItem value={30}>Reparacion</MenuItem>
